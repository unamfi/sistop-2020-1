...
def copy_from_computer_to_disk(route):
	...
	if len(file_content_locator) > 0: 
		init_cluster = str(int((file_content_locator[-1] + file_sizes[-1]) / 512))
	else: 
		init_cluster = '5'
	#Fecha de creación 
	...
	try:
		...
		print(chr(27)+"[1;31m"+'Archivo no compatible con el sistema de archivos.')
	file_system_disk.close()
	computer_file.close()
...
def delete_file(file_name):
	...
	file_system_disk = open(disk_name,'r+',encoding='utf-8')
	flag = 0
	while flag == 0: 
...
def help():
	print(chr(27)+"[1;33m"+'\t\tCOMANDO               \t \tDESCRIPCIÓN\n')
	print(chr(27)+"[1;33m"+'\t\tcptofi </path/of/file>\t - Copia un archivo de la computadora a FIUNAMFS')
	print(chr(27)+"[1;33m"+'\t\tcptopc <name_of_file>\t - Copia un archivo de FIUNAMFS a la computadora')
	print(chr(27)+"[1;33m"+'\t\tlist \t\t\t - Lista los archivos actualmente en FIUNAMFS')
	print(chr(27)+"[1;33m"+'\t\tdelete <name_of_file>\t - Borra un archivo de FIUNAMFS')
	print(chr(27)+"[1;33m"+'\t\tabfs (ABout File System) - Despliega una breve descripción de FIUNAMFS')
	print(chr(27)+"[1;33m"+'\t\tclear \t\t\t - Limpia la pantalla')
	print(chr(27)+"[1;33m"+'\t\thelp \t\t\t - Despliega la lista de comandos')
	print(chr(27)+"[1;33m"+'\t\texit \t\t\t - Salir del Sistma de Archivos')
def about_file_system():
	print(chr(27)+"[1;36m"+'\t\tAcerca de FIUNAMFS')
	print(chr(27)+"[1;36m"+'\t\tVersión 7.0')
	print(chr(27)+"[1;36m"+'\t\tFIUNAMFS es un sistema de archivos creado por alumnos de la Facultad')
	print(chr(27)+"[1;36m"+'\t\tde Ingeniería de la UNAM.\n')
	print(chr(27)+"[1;36m"+'\t\tNovedades:')
	print(chr(27)+"[1;36m"+'\t\t-\tProceso de desfragmentación automático')
...
def user_interface():
	...
	os.system('clear')
	print(chr(27)+"[1;32m"+'*********************************Bienvenido a FIUNAMFS*********************************')
	print(chr(27)+"[1;32m"+'Para enlistar los comando que están disponibles en el Sistema de Archivos teclee:')
	print(chr(27)+"[1;31m"+'---------->"help"')
	while True:
		...
		if option == 'exit' or command == 'exit':
			...
			if file_name in file_names: 
				...
				print(chr(27)+"[1;31m"+'No se encuentra el archivo ' + file_name)	
		elif command == 'cptofi':
			file = option[option.find(" ")+1:]
			try: 
				if os.path.getsize(file) > (os.path.getsize(disk_name)-5120):
					print(chr(27)+"[1;31m"+'Archivo demasiado grande.')
				else: 
					file_name = os.path.basename(file)
					if file_name in file_names:
						print(chr(27)+"[1;31m"+'Ya existe el archivo: ' + file_name)
				...
				print(chr(27)+"[1;31m"+"No existe el archivo: " + file)
		elif command == 'delete':
			file_name = option[option.find(" ")+1:]
			if file_name in file_names: 
				delete_file(file_name)
				...
				print(chr(27)+"[1;31m"+'No existe el archivo: ' + file_name)
